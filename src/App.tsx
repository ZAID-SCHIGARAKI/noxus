...
function listenToMediaQuery(media: MediaQueryList, listener: () => void): () => void {
  if (typeof media.addEventListener === "function") {
    media.addEventListener("change", listener);
    return () => media.removeEventListener("change", listener);
  }

  // Older iOS Safari versions only provide addListener/removeListener.
...
export default function App() {
  ...
  useEffect(() => {
    ...
    applyTheme();
    return listenToMediaQuery(media, applyTheme);
  }, [settings.theme]);
  ...
  useEffect(() => {
    ...
    updateInstalled();
    const stopInstalledListener = listenToMediaQuery(standaloneMedia, updateInstalled);
    return () => {
      window.removeEventListener("online", updateOnline);
      window.removeEventListener("offline", updateOnline);
      stopInstalledListener();
    };
  }, []);
